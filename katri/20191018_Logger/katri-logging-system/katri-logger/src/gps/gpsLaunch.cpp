...
GpsLaunch::GpsLaunch(QObject *parent)
    : QThread(parent)
{
...
void GpsLaunch::run()
{
    ...
    connect(_process,
            ...
            [=](QProcess::ProcessError error) {
                ...
                if (_logger)
                    _logger->debug("GNSS process occurred error: {}", msg.toStdString());
            });
    ...
    connect(_process,
            ...
            [=](int exitCode, QProcess::ExitStatus exitStatus) {
                ...
                if (_logger)
                    _logger->debug(
                        "GNSS process finished with exit code: {} and exist status: {}.",
                        exitCode,
                        msg.toStdString());
            });
...
//void GpsLaunch::captureDataOutput()
//{
