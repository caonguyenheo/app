...
#include "camera_dashboard/dashboardpanel.h"
#include "menubar.h"
...
public Q_SLOTS:
    ...
    void slotCameraDashboardClicked();
...
//    void handlerCameraControl(uint id, bool status);
    ...
    void slotSetLoggerConnected(QList<QString> deviceId);
    void slotRemoveLoggerConnected(QList<QString> nodeNameId);
Q_SIGNALS:
...
//    ViewCamera *m_viewCamera = nullptr;
    DashboardPanel *m_viewCamera = nullptr;
