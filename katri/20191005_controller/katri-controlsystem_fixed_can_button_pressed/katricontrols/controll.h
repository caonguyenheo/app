...
//    void resizeEvent(QResizeEvent *event) override;
    ...
    void AddNameLidarView(QStringList names);

    void setLidarLiveStreamAction(QString name, const QObject *receiver, const char *member);
Q_SIGNALS:
    void viewChartRelease();
    void viewCameraRelease();
    void viewLidarLiveStreamRelease();
