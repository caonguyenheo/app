...
const QStringList COMMON_NAME = QStringList() << "NAME" << "RECORD" << "STATUS";
const QStringList NAME_LIDAR =  QStringList() <<"Front" << "Top" << "Rear";
const QStringList NAME_SERIAL = QStringList() <<"C-CAN" << "Mobileye" << "Weather";
