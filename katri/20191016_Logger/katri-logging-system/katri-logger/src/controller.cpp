...
//    connect(_node, &NodeWorker::messageReceived, this, &Controller::doIt);
    connect(socket, &NodeWorker::messageReceived, this, &Controller::doIt);
...
//    _node->start();
    ...
    DataSourceManager::instance().setNode(socket);
    DataSourceManager::instance().setSocket(socket);
