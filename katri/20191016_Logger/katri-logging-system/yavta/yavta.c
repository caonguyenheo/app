...
enum buffer_fill_mode {
	BUFFER_FILL_NONE = 0, BUFFER_FILL_FRAME = 1 << 0, BUFFER_FILL_PADDING = 1
			<< 1,
};
...
static struct {
	...
	const char *string;
		...
		{ { V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE, 1, "Video capture mplanes",
				"capture-mplane", }, { V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE, 1,
				"Video output", "output-mplane", }, {
				V4L2_BUF_TYPE_VIDEO_CAPTURE, 1, "Video capture", "capture", },
				{ V4L2_BUF_TYPE_VIDEO_OUTPUT, 1, "Video output mplanes",
						"output", }, { V4L2_BUF_TYPE_VIDEO_OVERLAY, 0,
						"Video overlay", "overlay" }, {
						V4L2_BUF_TYPE_META_CAPTURE, 1, "Meta-data capture",
						"meta-capture", }, { V4L2_BUF_TYPE_META_OUTPUT, 1,
						"Meta-data output", "meta-output", }, };
...
} pixel_formats[] = { { "RGB332", V4L2_PIX_FMT_RGB332, 1 }, { "RGB444",
V4L2_PIX_FMT_RGB444, 1 }, { "ARGB444", V4L2_PIX_FMT_ARGB444, 1 }, { "XRGB444",
		V4L2_PIX_FMT_XRGB444, 1 }, { "RGB555", V4L2_PIX_FMT_RGB555, 1 }, {
		"ARGB555", V4L2_PIX_FMT_ARGB555, 1 }, { "XRGB555", V4L2_PIX_FMT_XRGB555,
		1 }, { "RGB565",
V4L2_PIX_FMT_RGB565, 1 }, { "RGB555X", V4L2_PIX_FMT_RGB555X, 1 }, { "RGB565X",
V4L2_PIX_FMT_RGB565X, 1 }, { "BGR666", V4L2_PIX_FMT_BGR666, 1 }, { "BGR24",
		V4L2_PIX_FMT_BGR24, 1 }, { "RGB24", V4L2_PIX_FMT_RGB24, 1 }, { "BGR32",
		V4L2_PIX_FMT_BGR32, 1 }, { "ABGR32", V4L2_PIX_FMT_ABGR32, 1 }, {
		"XBGR32", V4L2_PIX_FMT_XBGR32, 1 }, { "RGB32", V4L2_PIX_FMT_RGB32, 1 },
		{ "ARGB32", V4L2_PIX_FMT_ARGB32, 1 },
		{ "XRGB32", V4L2_PIX_FMT_XRGB32, 1 },
		{ "HSV24", V4L2_PIX_FMT_HSV24, 1 }, { "HSV32", V4L2_PIX_FMT_HSV32, 1 },
		{ "Y8", V4L2_PIX_FMT_GREY, 1 }, { "Y10", V4L2_PIX_FMT_Y10, 1 }, { "Y12",
		V4L2_PIX_FMT_Y12, 1 }, { "Y16", V4L2_PIX_FMT_Y16, 1 }, { "UYVY",
		V4L2_PIX_FMT_UYVY, 1 }, { "VYUY", V4L2_PIX_FMT_VYUY, 1 }, { "YUYV",
				V4L2_PIX_FMT_YUYV, 1 }, { "YVYU", V4L2_PIX_FMT_YVYU, 1 }, {
				"NV12", V4L2_PIX_FMT_NV12, 1 },
		{ "NV12M", V4L2_PIX_FMT_NV12M, 2 }, { "NV21", V4L2_PIX_FMT_NV21, 1 }, {
				"NV21M", V4L2_PIX_FMT_NV21M, 2 },
		{ "NV16", V4L2_PIX_FMT_NV16, 1 }, { "NV16M", V4L2_PIX_FMT_NV16M, 2 }, {
				"NV61", V4L2_PIX_FMT_NV61, 1 },
		{ "NV61M", V4L2_PIX_FMT_NV61M, 2 }, { "NV24", V4L2_PIX_FMT_NV24, 1 }, {
				"NV42", V4L2_PIX_FMT_NV42, 1 }, { "YUV420M",
				V4L2_PIX_FMT_YUV420M, 3 }, { "YUV422M",
		V4L2_PIX_FMT_YUV422M, 3 }, { "YUV444M", V4L2_PIX_FMT_YUV444M, 3 }, {
				"YVU420M",
				V4L2_PIX_FMT_YVU420M, 3 },
		{ "YVU422M", V4L2_PIX_FMT_YVU422M, 3 }, { "YVU444M",
		V4L2_PIX_FMT_YVU444M, 3 }, { "SBGGR8", V4L2_PIX_FMT_SBGGR8, 1 }, {
				"SGBRG8", V4L2_PIX_FMT_SGBRG8, 1 }, { "SGRBG8",
				V4L2_PIX_FMT_SGRBG8, 1 }, { "SRGGB8", V4L2_PIX_FMT_SRGGB8, 1 },
		{ "SBGGR10_DPCM8",
		V4L2_PIX_FMT_SBGGR10DPCM8, 1 }, { "SGBRG10_DPCM8",
		V4L2_PIX_FMT_SGBRG10DPCM8, 1 }, { "SGRBG10_DPCM8",
		V4L2_PIX_FMT_SGRBG10DPCM8, 1 }, { "SRGGB10_DPCM8",
		V4L2_PIX_FMT_SRGGB10DPCM8, 1 }, { "SBGGR10",
		V4L2_PIX_FMT_SBGGR10, 1 }, { "SGBRG10", V4L2_PIX_FMT_SGBRG10, 1 }, {
				"SGRBG10",
				V4L2_PIX_FMT_SGRBG10, 1 },
		{ "SRGGB10", V4L2_PIX_FMT_SRGGB10, 1 }, { "SBGGR10P",
		V4L2_PIX_FMT_SBGGR10P, 1 }, { "SGBRG10P", V4L2_PIX_FMT_SGBRG10P, 1 }, {
				"SGRBG10P", V4L2_PIX_FMT_SGRBG10P, 1 }, { "SRGGB10P",
		V4L2_PIX_FMT_SRGGB10P, 1 }, { "SBGGR12", V4L2_PIX_FMT_SBGGR12, 1 }, {
				"SGBRG12",
				V4L2_PIX_FMT_SGBRG12, 1 },
		{ "SGRBG12", V4L2_PIX_FMT_SGRBG12, 1 }, { "SRGGB12",
		V4L2_PIX_FMT_SRGGB12, 1 }, { "IPU3_SBGGR10",
		V4L2_PIX_FMT_IPU3_SBGGR10, 1 }, { "IPU3_SGBRG10",
		V4L2_PIX_FMT_IPU3_SGBRG10, 1 }, { "IPU3_SGRBG10",
		V4L2_PIX_FMT_IPU3_SGRBG10, 1 }, { "IPU3_SRGGB10",
		V4L2_PIX_FMT_IPU3_SRGGB10, 1 }, { "DV", V4L2_PIX_FMT_DV, 1 }, { "MJPEG",
				V4L2_PIX_FMT_MJPEG, 1 }, { "MPEG", V4L2_PIX_FMT_MPEG, 1 }, };
...
} fields[] = { { "any", V4L2_FIELD_ANY }, { "none", V4L2_FIELD_NONE }, { "top",
		V4L2_FIELD_TOP }, { "bottom", V4L2_FIELD_BOTTOM }, { "interlaced",
		V4L2_FIELD_INTERLACED }, { "seq-tb", V4L2_FIELD_SEQ_TB }, { "seq-bt",
		V4L2_FIELD_SEQ_BT }, { "alternate", V4L2_FIELD_ALTERNATE }, {
		"interlaced-tb", V4L2_FIELD_INTERLACED_TB }, { "interlaced-bt",
...
static int video_querycap(struct device *dev, unsigned int *capabilities) {
	...
	has_meta = caps & (V4L2_CAP_META_CAPTURE | V4L2_CAP_META_OUTPUT);
	has_capture = caps
			& (V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_VIDEO_CAPTURE
	...
	printf("Device `%s' on `%s' (driver '%s') supports%s%s%s%s %s mplanes.\n",
			cap.card, cap.bus_info, cap.driver, has_video ? " video," : "",
			has_meta ? " meta-data," : "", has_capture ? " capture," : "",
			has_output ? " output," : "", has_mplane ? "with" : "without");
...
static int get_control(struct device *dev,
		const struct v4l2_query_ext_ctrl *query, struct v4l2_ext_control *ctrl,
		unsigned int which) {
...
static int video_get_format(struct device *dev) {
	...
	if (video_is_mplane(dev)) {
		...
		printf("Meta-data format: %s (%08x) buffer size %u\n",
				...
				fmt.fmt.meta.dataformat, fmt.fmt.meta.buffersize);
	} else {
		...
		dev->plane_fmt[0].sizeimage =
				fmt.fmt.pix.bytesperline ? fmt.fmt.pix.sizeimage : 0;
		...
		printf(
				...
				fmt.fmt.pix.bytesperline, v4l2_field_name(fmt.fmt.pix_mp.field),
...
static int video_set_format(struct device *dev, unsigned int w, unsigned int h,
		unsigned int format, unsigned int stride, unsigned int buffer_size,
		enum v4l2_field field, unsigned int flags) {
	struct v4l2_format fmt;
	unsigned int i;
	int ret;
	...
	if (video_is_mplane(dev)) {
		...
		printf(
				...
				v4l2_format_name(fmt.fmt.pix.pixelformat),
				fmt.fmt.pix.pixelformat, fmt.fmt.pix.width, fmt.fmt.pix.height,
				fmt.fmt.pix.bytesperline, v4l2_field_name(fmt.fmt.pix.field),
				fmt.fmt.pix.sizeimage);
	}
...
static int video_set_framerate(struct device *dev,
...
static int video_buffer_alloc_userptr(struct device *dev, struct buffer *buffer,
		struct v4l2_buffer *v4l2buf, unsigned int offset, unsigned int padding) {
...
static void get_ts_flags(uint32_t flags, const char **ts_type,
...
static int video_alloc_buffers(struct device *dev, int nbufs,
	...
	for (i = 0; i < rb.count; ++i) {
		...
		case V4L2_MEMORY_USERPTR:
			ret = video_buffer_alloc_userptr(dev, &buffers[i], &buf, offset,
					padding);
			break;
		...
		if (video_is_mplane(dev)) {
			for (i = 0; i < dev->num_planes; i++) {
				buf.m.planes[i].m.userptr =
						(unsigned long) dev->buffers[index].mem[i];
	...
	for (i = 0; i < dev->num_planes; i++) {
		if (video_is_output(dev)) {
			...
			if (fill & BUFFER_FILL_PADDING)
				memset(
						dev->buffers[buf.index].mem[i]
								+ dev->buffers[index].size[i], 0x55,
...
static void video_query_menu(struct device *dev,
		const struct v4l2_query_ext_ctrl *query, unsigned int value) {
	struct v4l2_querymenu menu;
	int ret;

	for (menu.index = query->minimum; menu.index <= (unsigned) query->maximum;
			menu.index++) {
		menu.id = query->id;
...
static int video_get_control(struct device *dev,
		const struct v4l2_query_ext_ctrl *query, bool full) {
	struct v4l2_ext_control ctrl;
	unsigned int i;
	int ret;
...
static int video_parse_control_array(const struct v4l2_query_ext_ctrl *query,
		struct v4l2_ext_control *ctrl, const char *val) {
	unsigned int i;
	char *endptr;
	__u32 value;
...
static void video_enum_frame_intervals(struct device *dev, __u32 pixelformat,
	...
	for (i = 0;; ++i) {
		...
		case V4L2_FRMIVAL_TYPE_DISCRETE:
			printf("%u/%u", ival.discrete.numerator, ival.discrete.denominator);
			break;

		case V4L2_FRMIVAL_TYPE_CONTINUOUS:
			printf("%u/%u - %u/%u", ival.stepwise.min.numerator,
					ival.stepwise.min.denominator, ival.stepwise.max.numerator,
					ival.stepwise.max.denominator);
			return;

		case V4L2_FRMIVAL_TYPE_STEPWISE:
			printf("%u/%u - %u/%u (by %u/%u)", ival.stepwise.min.numerator,
					ival.stepwise.min.denominator, ival.stepwise.max.numerator,
					ival.stepwise.max.denominator, ival.stepwise.step.numerator,
...
static void video_enum_frame_sizes(struct device *dev, __u32 pixelformat) {
	...
	for (i = 0;; ++i) {
		...
		case V4L2_FRMSIZE_TYPE_CONTINUOUS:
			printf("\tFrame size: %ux%u - %ux%u (", frame.stepwise.min_width,
					frame.stepwise.min_height, frame.stepwise.max_width,
...
static void video_enum_formats(struct device *dev, enum v4l2_buf_type type) {
	...
	for (i = 0;; ++i) {
		...
		printf("\tFormat %u: %s (%08x)\n", i, v4l2_format_name(fmt.pixelformat),
				fmt.pixelformat);
	...
	for (plane = 0; plane < dev->num_planes; plane++) {
		...
		if (filename != NULL) {
			...
			if (ret != (int) size && dev->plane_fmt[plane].bytesperline != 0) {
				printf(
						"Test pattern file size %u doesn't match image size %u\n",
						ret, size);
				ret = -EINVAL;
				goto done;
			}
			...
			if (dev->plane_fmt[plane].bytesperline == 0) {
				printf(
						"Compressed format detected for plane %u and no test pattern filename given.\n"
...
static int video_prepare_capture(struct device *dev, int nbufs,
		unsigned int offset, const char *filename, enum buffer_fill_mode fill) {
...
static void video_save_image(struct device *dev, struct v4l2_buffer *buf,
		const char *pattern, unsigned int sequence, const char *timestamp,
		const char *ts_path) {
	unsigned int size;
	unsigned int i;
	char *filename;
	...
	p = strchr(pattern, '#');
	if (p != NULL) {
		sprintf(filename, "%.*s%09u%s", (int) (p - pattern), pattern, sequence,
				p + 1);
		append = false;
	} else {
	...
	if (ts_path != NULL) {
		FILE *tsFile;
		tsFile = fopen(ts_path, "a");
		fprintf(tsFile, "%s.%06ld\n", timestamp, buf->timestamp.tv_usec);
		fclose(tsFile);
	}
}

unsigned int video_buffer_bytes_used(struct device *dev,
		struct v4l2_buffer *buf) {
...
static long getEpochTimeShift() {
	...
	long uptime_ms = vsTime.tv_sec * 1000
			+ (long) round(vsTime.tv_nsec / 1000000.0);
	long epoch_ms = epochtime.tv_sec * 1000
...
static int video_do_capture(struct device *dev, unsigned int nframes,
		...
		enum buffer_fill_mode fill, const char *ts_path, long toEpochOffset_ms) {
	struct v4l2_plane planes[VIDEO_MAX_PLANES];
	struct v4l2_buffer buf;
	...
	for (i = 0; i < nframes && !terminate; ++i) {
		...
		/*  Check if value of timestamp is valid. */
		...
		long epochTimeStamp_ms = 1000 * buf.timestamp.tv_sec + toEpochOffset_ms;

		ts_temp.tv_sec = epochTimeStamp_ms / 1000;
		ts_temp.tv_nsec = buf.timestamp.tv_usec * 1000;

		tm_tmp = *localtime(&ts_temp.tv_sec);
		strftime(timestring, 24, "%Y-%m-%d %H:%M:%S", &tm_tmp);

		clock_gettime(CLOCK_MONOTONIC, &ts);
		get_ts_flags(buf.flags, &ts_type, &ts_source);
		printf(
				"%u (%u) [%c] %s %u %u B %ld.%06ld %ld.%06ld %.3f fps ts %s/%s (%s.%06ld)\n",
				i, buf.index, (buf.flags & V4L2_BUF_FLAG_ERROR) ? 'E' : '-',
				v4l2_field_name(buf.field), buf.sequence,
				video_buffer_bytes_used(dev, &buf), buf.timestamp.tv_sec,
				buf.timestamp.tv_usec, ts.tv_sec, ts.tv_nsec / 1000, fps,
				ts_type, ts_source, timestring, buf.timestamp.tv_usec);

		last = buf.timestamp;

		/* Save the image. */
		if (video_is_capture(dev) && pattern && !skip)
			video_save_image(dev, &buf, pattern, i, timestring, ts_path);
	...
	printf("Captured %u frames in %lu.%06lu seconds (%f fps, %f B/s).\n", i,
			ts.tv_sec, ts.tv_nsec / 1000, fps, bps);

	done: return video_free_buffers(dev);
}
...
static void usage(const char *argv0) {
	...
	printf("    --timestamp[=ts_path]	Generate timestamp for each frame in text file.\n");
	printf("\tThe default file name is timestamps.txt.\n");
}
...
#define OPT_TSTAMP_PATH 273

static struct option opts[] = { { "buffer-size", 1, 0, OPT_BUFFER_SIZE }, {
		"buffer-type", 1, 0, 'B' }, { "capture", 2, 0, 'c' }, { "check-overrun",
		0, 0, 'C' }, { "data-prefix", 0, 0, OPT_DATA_PREFIX }, { "delay", 1, 0,
		'd' }, { "enum-formats", 0, 0, OPT_ENUM_FORMATS }, { "enum-inputs", 0,
		0, OPT_ENUM_INPUTS }, { "fd", 1, 0, OPT_FD },
		{ "field", 1, 0, OPT_FIELD }, { "file", 2, 0, 'F' }, { "fill-frames", 0,
				0, 'I' }, { "format", 1, 0, 'f' }, { "help", 0, 0, 'h' }, {
				"input", 1, 0, 'i' }, { "list-controls", 0, 0, 'l' }, {
				"log-status", 0, 0, OPT_LOG_STATUS }, { "nbufs", 1, 0, 'n' }, {
				"no-query", 0, 0, OPT_NO_QUERY }, { "offset", 1, 0,
		OPT_USERPTR_OFFSET }, { "pause", 2, 0, 'p' }, { "premultiplied", 0, 0,
				OPT_PREMULTIPLIED }, { "quality", 1, 0, 'q' }, { "queue-late",
				0, 0, OPT_QUEUE_LATE }, { "get-control", 1, 0, 'r' }, {
				"requeue-last", 0, 0, OPT_REQUEUE_LAST }, { "reset-controls", 0,
				0,
				OPT_RESET_CONTROLS }, { "realtime", 2, 0, 'R' }, { "size", 1, 0,
				's' }, { "set-control", 1, 0, 'w' }, { "skip", 1, 0,
		OPT_SKIP_FRAMES }, { "sleep-forever", 0, 0, OPT_SLEEP_FOREVER }, {
				"stride", 1, 0, OPT_STRIDE }, { "time-per-frame", 1, 0, 't' }, {
				"timestamp-source", 1, 0, OPT_TSTAMP_SRC }, { "userptr", 0, 0,
				'u' }, { "timestamp", 2, 0, OPT_TSTAMP_PATH }, { 0, 0, 0, 0 } };

/* Signal Handler for SIGTERM */
void sigintHandler(int sig_num) {
	printf("Received SIGNTERM signal %d, the process will be stopped soon.",
			sig_num);
	terminate = true;
}
int main(int argc, char *argv[]) {
	// Calculate epoch offset
	long epochOffset_ms = getEpochTimeShift();
	...
	int do_ts = 0, do_file = 0, do_capture = 0;
	...
	const char *ts_path = "timestamps.txt";
	...
	opterr = 0;
	while ((c = getopt_long(argc, argv, "B:c::Cd:f:F::hi:Iln:p::q:r:R::s:t:uw:",
			opts, NULL)) != -1) {
		switch (c) {
		case 'B':
	...
	if (video_do_capture(&dev, nframes, skip, delay, pause_count, filename,
			do_requeue_last, do_queue_late, fill_mode, ts_path, epochOffset_ms)
			< 0) {
		video_close(&dev);
		return 1;
	}
