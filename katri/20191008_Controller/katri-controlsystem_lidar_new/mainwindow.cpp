...
void MainWindow::setupUi()
{
    ...
    m_livestreamlidarview = new LidarView(this);
    ...
    layout->addWidget(m_livestreamlidarview);
    ...
    m_viewer->LidarLiveStreamConnection(this, SLOT(slotLiveStreamClicked()));
    ...
    m_livestreamlidarview->backButtonConnection(this, SLOT(slotbackButtonClicked()));
    ...
    m_livestreamlidarview->setVisible(false);
...
void MainWindow::slotLiveStreamClicked()
{
    qDebug()<<"slotLiveStreamClicked()";
    m_viewer->setVisible(false);
    m_record->setVisible(false);
    this->setMinimumSize(1010, 580);
    this->resize(1010, 580);
    this->geometry().x();
    m_livestreamlidarview->setVisible(true);
}
